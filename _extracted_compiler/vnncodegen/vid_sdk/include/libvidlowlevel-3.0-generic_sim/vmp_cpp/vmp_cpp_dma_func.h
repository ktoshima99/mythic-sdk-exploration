...
#ifndef __VMP_CPP_DMA_FUNC_H__
#define __VMP_CPP_DMA_FUNC_H__
...
inline void vmp_dma_read(const uint2 extByteaddr,
                    __BYTEADDRESS void* intWordaddr,
                    const uint length,
...
/// @endcond
inline void vmp_dma_read(const uint2 extByteaddr,
                    __BYTEADDRESS uchar8* intWordaddr,
                    const uint length,
                    const uint dmaChannelId)
{
    vmp_dma_read(extByteaddr, as_ushort4(set_uint2(length, (uint)__builtin_vmp_convert_byteaddresstowordaddress((PCAST)intWordaddr))),
...
/// @endcond
inline void vmp_dma_read(const uint2 extByteaddr,
                    __BYTEADDRESS char8* intWordaddr,
                    const uint length,
                    const uint dmaChannelId)
{
    vmp_dma_read(extByteaddr, as_ushort4(set_uint2(length, (uint)__builtin_vmp_convert_byteaddresstowordaddress((PCAST)intWordaddr))),
...
/// @endcond
inline void vmp_dma_read(const uint2 extByteaddr,
                    __BYTEADDRESS ushort4* intWordaddr,
                    const uint length,
                    const uint dmaChannelId)
{
    vmp_dma_read(extByteaddr, as_ushort4(set_uint2(length, (uint)__builtin_vmp_convert_byteaddresstowordaddress((PCAST)intWordaddr))),
...
/// @endcond
inline void vmp_dma_read(const uint2 extByteaddr,
                    __BYTEADDRESS short4* intWordaddr,
                    const uint length,
                    const uint dmaChannelId)
{
    vmp_dma_read(extByteaddr, as_ushort4(set_uint2(length, (uint)__builtin_vmp_convert_byteaddresstowordaddress((PCAST)intWordaddr))),
...
/// @endcond
inline void vmp_dma_read(const uint2 extByteaddr,
                    __BYTEADDRESS int2* intWordaddr,
                    const uint length,
                    const uint dmaChannelId)
{
    vmp_dma_read(extByteaddr, as_ushort4(set_uint2(length, (uint)__builtin_vmp_convert_byteaddresstowordaddress((PCAST)intWordaddr))),
...
/// @endcond
inline void vmp_dma_read(const uint2 extByteaddr,
                    __BYTEADDRESS ulong1* intWordaddr,
                    const uint length,
                    const uint dmaChannelId)
{
    vmp_dma_read(extByteaddr, as_ushort4(set_uint2(length, (uint)__builtin_vmp_convert_byteaddresstowordaddress((PCAST)intWordaddr))),
...
/// @endcond
inline void vmp_dma_read(const uint2 extByteaddr,
                    __BYTEADDRESS long1* intWordaddr,
                    const uint length,
                    const uint dmaChannelId)
{
    vmp_dma_read(extByteaddr, as_ushort4(set_uint2(length, (uint)__builtin_vmp_convert_byteaddresstowordaddress((PCAST)intWordaddr))),
...
{
    vmp_dma_read(extByteaddr, as_ushort4(set_uint2(length, (uint)__builtin_vmp_convert_byteaddresstowordaddress((PCAST)intWordaddr))),
                as_ushort4(set_uint2(count_stride[1], 0u)), set_uint2(count_stride[0], 0u),
                dmaChannelId);
}
