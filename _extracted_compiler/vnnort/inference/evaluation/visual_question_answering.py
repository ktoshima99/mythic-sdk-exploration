...
from vnnort.data.container import VisualQuestionAnsweringInput, VisualQuestionAnsweringOutput
from vnnort.inference.evaluation.benchmark_base import BenchmarkBase


class VisualQuestionAnsweringBenchmark(BenchmarkBase):
    """Class for benchmarking visual question answering models."""
    ...
    def update(self, input_data: list[VisualQuestionAnsweringInput], output_data: list[VisualQuestionAnsweringOutput]) -> None:  # type: ignore
        ...
        Args:
            input_data (list[VisualQuestionAnsweringInput]): Input data to the model
            output_data (list[VisualQuestionAnsweringOutput]): Output data from the model

        Returns:
            None: None
        """
        gt_answers = [input_sample.answer for input_sample in input_data]
        pred_answers = [output.answer for output in output_data]
