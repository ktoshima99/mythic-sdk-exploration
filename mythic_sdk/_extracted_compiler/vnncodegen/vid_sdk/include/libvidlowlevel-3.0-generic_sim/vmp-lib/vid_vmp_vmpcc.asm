...
.macro vmp_popcount_16(_dst, _op)
    ...
    V_SLICS_16   mvtmp1, _op, #1
    V_ADDICR_16  mvtmp0, mvtmp0, #1

.loop cnt=[0..13]
    V_SLICS_16   mvtmp1, mvtmp1, #1
    V_ADDICR_16  mvtmp0, mvtmp0, #1
.endloop

    V_SLICS_16   mvtmp1, mvtmp1, #1
    V_ADDICR_16  _dst, mvtmp0, #1
.endmacro
...
.macro vmp_popcount_32(_dst, _op)
    ...
    V_SLICS_32   mvtmp1, _op, #1
    V_ADDICR_32  mvtmp0, mvtmp0, #1

.loop cnt=[0..29]
    V_SLICS_32   mvtmp1, mvtmp1, #1
    V_ADDICR_32  mvtmp0, mvtmp0, #1
.endloop

    V_SLICS_32   mvtmp1, mvtmp1, #1
    V_ADDICR_32  _dst, mvtmp0, #1
.endmacro
