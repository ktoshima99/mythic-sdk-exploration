 ...
 *++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
 *
 * FILENAME: vid_vmp_olm_preload_template.asm
 *
 * DESCRIPTION: videantis v-MP overlay manager preload template file
 *                - sets parameters for VID_VMP_OVERLAY_MANAGER
 *                - VID_VMP_OVERLAY_MANAGER returns to caller address in lr
...
// VIDASM_OLM_STATUS_WIDTH              status word width (in bits)
// VIDASM_OLM_STATUS_OVERLAY_STORAGE    type of overlays in status word:
//					0 - single bit
//					1 - a value
