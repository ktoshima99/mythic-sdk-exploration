...
#include "vmp_cpp_endianness_dma_func.h"
...
/// @brief All dma channel descriptors allocated in vid_vmp_dma.asm
extern volatile vid_edma_descr_t vid_edma_descr;
extern volatile uint2 vid_edma_extDescrAddr;
extern volatile uint2 vid_edma_chStatus;
                ...
                const uint edmaChannelId)
{
    ...
    vid_edma_extDescrAddr = extDescrAddr;
    ...
    const uint2 edmaRegintWordaddr_length = set_uint2(1u, (uint)__builtin_vmp_convert_byteaddresstowordaddress((int)&vid_edma_extDescrAddr));
                ...
                const uint edmaChannelId)
{
    ...
    vid_edma_descr.tgtAddr = tgtAddr;
    vid_edma_descr.srcAddr = srcAddr;
    vid_edma_descr.t.flags_count_lengthHi_lengthLo = flags_count_lengthHi_lengthLo;
    vid_edma_descr.srcStride_tgtStride = srcStride_tgtStride;

    // setup DMA transfer to transfer EDMA descriptor into external memory
    const uint2 intWordaddr_length = set_uint2(SIZEOF_IN_WORDS(vid_edma_descr_t), (uint)__builtin_vmp_convert_byteaddresstowordaddress((int)&vid_edma_descr));
    ...
    const uint2 writeBackintWordaddr_length = set_uint2(1u, (uint)__builtin_vmp_convert_byteaddresstowordaddress((int)&vid_edma_chStatus));
                ...
                const uint edmaChannelId)
{
    ...
    vid_edma_descr.tgtAddr = tgtAddr;
    vid_edma_descr.srcAddr = srcAddr;
    vid_edma_descr.t.count_length = count_length;
    vid_edma_descr.srcStride_tgtStride = srcStride_tgtStride;
...
inline uint vmp_edma_check(const uint edmaChannelId)
{
    ...
    const uint2 edmaStatusintWordaddr_length = set_uint2(1u, (uint)__builtin_vmp_convert_byteaddresstowordaddress((int)&vid_edma_chStatus));
